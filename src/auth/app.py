...
def register_user():
    try:
        ...
        response = requests.post(USER_URL+"/init-user", json={"userID": user["userID"]}, verify=False)
...
def delete_user():
    try:
        ...
        response = requests.post(USER_URL+"/delete_user", json={"userID": userID}, verify=False)
